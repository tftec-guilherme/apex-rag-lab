...
# HelpSphere — Story 06.5a Sessão 2.3 (driver SQL + repositories)
CONFIG_SQL_POOL = "sql_pool"
CONFIG_TICKETS_REPO = "tickets_repo"
CONFIG_COMMENTS_REPO = "comments_repo"
CONFIG_TENANTS_REPO = "tenants_repo"
